...
const DistributedBarChartPurchaseReturn = () => {
  // Hooks
  ...
  return (
    <Card className='min-h-[220px]'>
      <CardHeader title='Purchase Return' subheader='Last Week' className='pbe-0' />
...
export default DistributedBarChartPurchaseReturn
