...
import AddBranchesDrawer from './AddBranchesDrawer'
import EditBranchesModal from './EditBranchesModal'
          ...
          return (
            <Switch
              ...
              onChange={() => {
                ...
                setData(prev =>
                  prev.map(item =>
                    item.sl === row.original.sl ? { ...item, status: isActive ? 'Inactive' : 'Active' } : item
                  )
                )
              }}
            />
