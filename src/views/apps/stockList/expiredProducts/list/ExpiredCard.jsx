...
const ExpiredCard = ({ expiredProducts }) => {
  const totalQty = expiredProducts.reduce((acc, item) => acc + item.stock, 0)

  const totalStockValue = expiredProducts.reduce((acc, item) => acc + item.purchasePrice * item.stock, 0)
