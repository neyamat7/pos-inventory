...
const CustomersListTable = ({ customerReportData = [] }) => {
  // States
  ...
  const columns = [
    ...
    { accessorKey: 'totalPurchase', header: 'Total Purchase' },
  ...
  return (
    <>
      ...
      <ViewSupplierModal open={viewOpen} handleClose={() => setViewOpen(false)} data={selectedRow} />
    </>
  )
}
